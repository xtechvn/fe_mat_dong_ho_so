using NewSolution.Controllers.Home.Service;
using NewSolution.Controllers.Product.Service;
using NewSolution.Service.Redis;
using Microsoft.AspNetCore.Mvc;
using Microsoft.Extensions.Caching.Memory;

namespace NewSolution.ViewComponents.Product
{
    public class ProductListViewComponent: ViewComponent
    {
        ...
        public async Task<IViewComponentResult?> InvokeAsync(int _group_product_id, int _page_index, int _page_size, string view_name)
        {
            ...
            try
            {
                ...
                var cacheKey = "product_list_oclock_" + _group_product_id + "_" + _page_index + _page_size; // Đặt khóa cho cache
